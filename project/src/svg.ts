import default_settings, { Settings } from "./settings";
	...
	_getSymbol( name: string, x: number, y: number){
		switch(name) {
	 ...
	 * @return {SVGElement g}
	 */
	getSymbol( name: string, x: number, y: number){
	 ...
	 */
	createRectForClick(x: number, y: number) {
		var rect = document.createElementNS(this.context.root.namespaceURI, 'rect')
	 ...
	 * @return {String id}
	 */
	getHouseIdWrapper(house: string) {
...
/*
 ...
 sun( x: number, y: number ){
	...
	var wrapper = document.createElementNS(this.context.root.namespaceURI, "g");
	wrapper.setAttribute("transform", "translate(" + ( -x * (this.settings.SYMBOL_SCALE - 1)) + "," + (-y * (this.settings.SYMBOL_SCALE - 1)) + ") scale(" + this.settings.SYMBOL_SCALE + ")");
		...
		var node = document.createElementNS( this.context.root.namespaceURI, "path");
 ...
 */
 mercury( x: number, y: number ){
	...
	wrapper.setAttribute("transform", "translate(" + ( -x * (this.settings.SYMBOL_SCALE - 1)) + "," + (-y * (this.settings.SYMBOL_SCALE - 1)) + ") scale(" + this.settings.SYMBOL_SCALE + ")");
		...
		var body = document.createElementNS( this.context.root.namespaceURI, "path");
		...
		var crown = document.createElementNS( this.context.root.namespaceURI, "path");
 ...
 */
 uranus( x: number, y: number ){
	...
	wrapper.setAttribute("transform", "translate(" + ( -x * (this.settings.SYMBOL_SCALE - 1)) + "," + (-y * (this.settings.SYMBOL_SCALE - 1)) + ") scale(" + this.settings.SYMBOL_SCALE + ")");
		...
		var horns = document.createElementNS( this.context.root.namespaceURI, "path");
 ...
 */
 pluto( x: number, y: number ){
	...
	wrapper.setAttribute("transform", "translate(" + ( -x * (this.settings.SYMBOL_SCALE - 1)) + "," + (-y * (this.settings.SYMBOL_SCALE - 1)) + ") scale(" + this.settings.SYMBOL_SCALE + ")");
		...
		var headYShift = 0; //px
		var head = document.createElementNS( this.context.root.namespaceURI, "path");
 ...
 */
 ...
 number10(x: number, y: number){
	...
	wrapper.setAttribute("transform", "translate(" + ( -x * (this.settings.SYMBOL_SCALE - 1)) + "," + (-y * (this.settings.SYMBOL_SCALE - 1)) + ") scale(" + this.settings.SYMBOL_SCALE + ")");
		...
		var one = document.createElementNS( this.context.root.namespaceURI, "path");
		...
		var zero = document.createElementNS( this.context.root.namespaceURI, "path");
 ...
 number11(x: number, y: number){
	...
	wrapper.setAttribute("transform", "translate(" + ( -x * (this.settings.SYMBOL_SCALE - 1)) + "," + (-y * (this.settings.SYMBOL_SCALE - 1)) + ") scale(" + this.settings.SYMBOL_SCALE + ")");
		...
		var one2 = document.createElementNS( this.context.root.namespaceURI, "path");
 ...
 number12(x: number, y: number){
	...
	wrapper.setAttribute("transform", "translate(" + ( -x * (this.settings.SYMBOL_SCALE - 1)) + "," + (-y * (this.settings.SYMBOL_SCALE - 1)) + ") scale(" + this.settings.SYMBOL_SCALE + ")");
		...
		var two = document.createElementNS( this.context.root.namespaceURI, "path");
 ...
 */  
segment( x: number, y: number, radius: number, a1: number, a2: number, thickness: number, lFlag?: number, sFlag?: number){
	...
	var segment = document.createElementNS( this.context.root.namespaceURI, "path");
...
line( x1: number, y1: number, x2: number, y2: number){									            	 	            	
	var line = document.createElementNS( this.context.root.namespaceURI, "line");
...
circle( cx: number, cy: number, radius: number){						            	 	            		
	var circle = document.createElementNS( this.context.root.namespaceURI, "circle");
 ...
 */  
text( txt: string, x: number, y: number, size: string, color: string){						            	 	            		
	var text = document.createElementNS( this.context.root.namespaceURI, "text");
