import default_settings from "./settings";
	...
	getSymbol( name, x, y){
		...
		const symbol = this.settings.CUSTOM_SYMBOL_FN(name, x, y, context);
	...
	createRectForClick(x, y) {
		...
		rect.setAttribute('x', x - this.settings.SIGNS_STROKE)
		rect.setAttribute('y', y - this.settings.SIGNS_STROKE)
	 ...
	 */
	 getSignWrapperId(sign) {
		return this.settings._paperElementId + '-' + this.settings.ID_RADIX + '-' + this.settings.ID_SIGNS + '-' + sign
	}
	...
	getHouseIdWrapper(house) {
		return this.settings._paperElementId + '-' + this.settings.ID_RADIX + '-' + this.settings.ID_CUSPS + '-' + house
	}
...
/*
 ...
 sun( x, y ){
	...
	wrapper.setAttribute("transform", "translate(" + ( -x * (this.settings.SYMBOL_SCALE - 1)) + "," + (-y * (this.settings.SYMBOL_SCALE - 1)) + ") scale(" + this.settings.SYMBOL_SCALE + ")");
		...
		node.setAttribute("stroke-width", this.settings.POINTS_STROKE);					
 ...
 */
 mercury( x, y ){
	...
	wrapper.setAttribute("transform", "translate(" + ( -x * (this.settings.SYMBOL_SCALE - 1)) + "," + (-y * (this.settings.SYMBOL_SCALE - 1)) + ") scale(" + this.settings.SYMBOL_SCALE + ")");
		...
		body.setAttribute("stroke-width", this.settings.POINTS_STROKE);
		...
		crown.setAttribute("stroke-width", this.settings.POINTS_STROKE);
 ...
 */
 uranus( x, y ){
	...
	wrapper.setAttribute("transform", "translate(" + ( -x * (this.settings.SYMBOL_SCALE - 1)) + "," + (-y * (this.settings.SYMBOL_SCALE - 1)) + ") scale(" + this.settings.SYMBOL_SCALE + ")");
		...
		horns.setAttribute("stroke-width", this.settings.POINTS_STROKE);
 ...
 */
 pluto( x, y ){
	...
	wrapper.setAttribute("transform", "translate(" + ( -x * (this.settings.SYMBOL_SCALE - 1)) + "," + (-y * (this.settings.SYMBOL_SCALE - 1)) + ") scale(" + this.settings.SYMBOL_SCALE + ")");
		...
		head.setAttribute("stroke-width", this.settings.POINTS_STROKE);
 ...
 */
 aries( x, y ){
	...
	wrapper.setAttribute("transform", "translate(" + ( -x * (this.settings.SYMBOL_SCALE - 1)) + "," + (-y * (this.settings.SYMBOL_SCALE - 1)) + ") scale(" + this.settings.SYMBOL_SCALE + ")");
		...
		node.setAttribute("stroke-width", this.settings.SIGNS_STROKE);			
		node.setAttribute("fill", "none");	
 ...
 */
 ascendant( x, y ){
	...
	wrapper.setAttribute("transform", "translate(" + ( -x * (this.settings.SYMBOL_SCALE - 1)) + "," + (-y * (this.settings.SYMBOL_SCALE - 1)) + ") scale(" + this.settings.SYMBOL_SCALE + ")");
		...
		node.setAttribute("stroke-width", (this.settings.SYMBOL_AXIS_STROKE * this.settings.SYMBOL_SCALE));			
		node.setAttribute("fill", "none");	
 ...
 */
 ...
 number1(x,y){
	...
	wrapper.setAttribute("transform", "translate(" + ( -x * (this.settings.SYMBOL_SCALE - 1)) + "," + (-y * (this.settings.SYMBOL_SCALE - 1)) + ") scale(" + this.settings.SYMBOL_SCALE + ")");
		...
		node.setAttribute("stroke-width", (this.settings.CUSPS_STROKE * this.settings.SYMBOL_SCALE));
		node.setAttribute("fill", "none");															
		wrapper.appendChild(node);
 ...
 number10(x,y){
	...
	wrapper.setAttribute("transform", "translate(" + ( -x * (this.settings.SYMBOL_SCALE - 1)) + "," + (-y * (this.settings.SYMBOL_SCALE - 1)) + ") scale(" + this.settings.SYMBOL_SCALE + ")");
		...
		one.setAttribute("stroke-width", (this.settings.CUSPS_STROKE * this.settings.SYMBOL_SCALE));
		...
		zero.setAttribute("stroke-width", (this.settings.CUSPS_STROKE * this.settings.SYMBOL_SCALE));
 ...
 number11(x,y){
	...
	wrapper.setAttribute("transform", "translate(" + ( -x * (this.settings.SYMBOL_SCALE - 1)) + "," + (-y * (this.settings.SYMBOL_SCALE - 1)) + ") scale(" + this.settings.SYMBOL_SCALE + ")");
		...
		one2.setAttribute("stroke-width", (this.settings.CUSPS_STROKE * this.settings.SYMBOL_SCALE));
 ...
 number12(x,y){
	...
	wrapper.setAttribute("transform", "translate(" + ( -x * (this.settings.SYMBOL_SCALE - 1)) + "," + (-y * (this.settings.SYMBOL_SCALE - 1)) + ") scale(" + this.settings.SYMBOL_SCALE + ")");
		...
		two.setAttribute("stroke-width", (this.settings.CUSPS_STROKE * this.settings.SYMBOL_SCALE));
