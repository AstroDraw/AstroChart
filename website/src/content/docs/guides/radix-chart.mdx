...
You can customize orbs via [Settings](../api/settings).
...
- **[Transit Charts](./transit-chart)** — Layer a transit ring over your radix
- **[Animation](./animation)** — Animate transitions between states
- **[Custom Settings](./custom-settings)** — Customize colors, fonts, and appearance
- **[Custom Symbols](./custom-symbols)** — Replace symbols with custom SVG
