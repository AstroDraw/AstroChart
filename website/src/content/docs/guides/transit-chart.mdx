...
const radixData = {
  ...
  cusps: [315.45, 35.67, 65.23, 92.45, 125.67, 155.89, 135.45, 215.67, 245.23, 272.45, 305.67, 335.89],
}
...
When `SHOW_DIGNITIES_TEXT` is enabled (default), transit planets display the same dignity labels as radix planets.
The displayed label reflects the transiting planet's current sign position.
